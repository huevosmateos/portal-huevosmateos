...
#  Modifica unicamente:
#     - en tienda.html: la lista de productos (var PRODUCTOS=...),
#       el orden de familias (var ORDEN_FAM=...) y el menu lateral (<ul id="fam-list">)
#       (tiendaconprecio.html ya NO se toca: carga los datos desde Supabase)
#     - en index.html, tienda.html, contacto.html y tiendaconprecio.html:
#       la lista de categorias del pie (<ul class="pie-cats">)
#     - copia/actualiza las fotos en la carpeta img
#     - en tiendaconprecio.html: solo HABITUALES (los demas datos vienen de Supabase)
#
...
def cargar_habituales():
    ...
    # --- 4) Escribir HABITUALES en tiendaconprecio.html ---
    # (CLIENTES_COD y TARIFAS ya no se escriben: ahora vienen de Supabase)
...
def main():
    ...
    # tiendaconprecio.html ya NO se actualiza con PRODUCTOS: los carga de Supabase
